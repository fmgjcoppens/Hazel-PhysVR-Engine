...
namespace HazelPVR
{
    ...
    {
        s_Data->TextureShader->SetFloat("u_TexScale", 1.0f);
    ...
    void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const Ref<Texture2D>& texture, const glm::vec4& texcolblend)
    {
        DrawQuad({position.x, position.y, 0.0f}, size, texture, texcolblend);
    }

    void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D>& texture, const glm::vec4& texcolblend)
    {
        s_Data->TextureShader->SetFloat("u_TexScale", 1.0f);
        s_Data->TextureShader->SetFloat4("u_Color", texcolblend);
        texture->Bind();
